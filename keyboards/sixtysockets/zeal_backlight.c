...
// index in range 0..71 (LA0..LA17, LB0..LB17, LC0..LC17, LD0..LD17)(17,16)
// point values in range x=0..224 y=0..64
// origin is center of top-left key (i.e Esc)
const Point g_map_led_to_point[72] PROGMEM = {
	// LA0..LA17
	{255,255}, {224,0}, {204,0}, {187,0}, {170,0}, {153,0}, {136,0}, {119,0}, {119,16},
	{136,16}, {153,16}, {170,16}, {187,16}, {204,16}, {224,8}, {204,32}, {187,32}, {255,255},
	// LB0..LB17
	{255,255}, {170,48}, {153,48}, {136,48}, {119,48}, {119,32}, {136,32}, {153,32}, {170,32},
	{187,48}, {224,48}, {224,64}, {204,64}, {187,64}, {170,64}, {255,255}, {255,255}, {255,255},
	// LC0..LC17
...
//
// Maps switch matrix coordinate (row,col) to LED index (18)
//
...
const uint8_t g_map_row_column_to_led[MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
	{  36+7,  36+6,  36+5,  36+4,  36+3,  36+2,  36+1,   0+7,   0+6,   0+5,   0+4,   0+3,   0+2,   0+1 },
	{  36+8,  36+9, 36+10, 36+11, 36+12, 36+13, 36+14,   0+8,   0+9,  0+10,  0+11,  0+12,  0+13,   255 },
	{  54+4,  54+5,  54+6,  54+7,  54+8, 36+16, 36+15,  18+5,  18+6,  18+7,  18+8,  0+16,  0+15,  0+14 },
	{  54+3,  54+2,  54+1,  54+9, 54+10, 54+11, 54+12,  18+4,  18+3,  18+2,  18+1,  18+9,   255, 18+10 },
	{ 54+16, 54+15, 54+14,   255,   255,   255, 54+13,   255,   255,   255, 18+14, 18+13, 18+12, 18+11 }
};
...
void backlight_init_drivers(void)
{
	...
	for ( int index = 0; index < 72; index++ )
	{
		...
		bool enabled = ! ( (index == 0+0) || (index == 0+17) || (index == 18+0) || (index == 18+17) ||
                           (index == 36+0) || (index == 36+17) || (index == 54+0) || (index == 54+17) ||
                           (index == 18+16) || (index == 18+15) );
